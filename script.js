...
const CONFIG = {
  ...
  weddingTime: "7:00 PM",
  weddingLocation: "Royal Tut",
  weddingLocationAr: "Royal Tut",
  weddingMapLink:
    "https://www.google.com/maps?q=4Q82+25H+Horus+Resort+Menia,+Kornish+Al+Nile,+الكورنيش،+Minya,+Minya+Governorate+2451205,+Egypten&ftid=0x145b24f09217d047:0x742598a281e93ed0&entry=gps&shh=CAE&lucs=,94297699,94231188,94280568,100821555,47071704,94218641,94282134,100835694,94286869,100820247,100822504&g_ep=CAISEjI2LjM3LjMuOTc3MTgxMTk2MBgAINeCAypnLDk0Mjk3Njk5LDk0MjMxMTg4LDk0MjgwNTY4LDEwMDgyMTU1NSw0NzA3MTcwNCw5NDIxODY0MSw5NDI4MjEzNCwxMDA4MzU2OTQsOTQyODY4NjksMTAwODIwMjQ3LDEwMDgyMjUwNEICU0U%3D&skid=3cdfd635-9217-4fc5-8fdb-d43f91e469ce&g_st=ii",

      // --- Church Info ---
  churchName: "Abu Qirqas",
  churchNameAr: "Abu Qirqas",
  churchTime: "6:00 PM",
  churchMapLink: "https://www.google.com/maps/place/%D9%83%D9%86%D9%8A%D8%B3%D8%A9+%D8%A7%D9%84%D8%B4%D9%87%D9%8A%D8%AF+%D8%A7%D9%84%D8%B9%D8%B8%D9%8A%D9%85+%D9%85%D8%A7%D8%B1%D8%AC%D8%B1%D8%AC%D8%B3+%D8%A7%D9%84%D8%B1%D9%88%D9%85%D8%A7%D9%86%D9%8A%E2%80%AD/@27.9288938,30.8230276,17z/data=!3m1!4b1!4m6!3m5!1s0x145b2b000133e74b:0xe384ca539a7868c0!8m2!3d27.9288938!4d30.8230276!16s%2Fg%2F11whq6nw03!18m1!1e1?entry=ttu&g_ep=EgoyMDI2MDkxNi4wIKXMDSoASAFQAw%3D%3D",  
  churchImage: "assets/images/church.jpg",

  // --- WhatsApp Numbers (for RSVP) ---
  groomWhatsapp: "46723149435",
...
function injectContent() {
  ...
  hennaMapBtns.forEach(
    ...
    // Church Data
  const churchNameEn = document.getElementById("church-name-en");
  const churchNameAr = document.getElementById("church-name-ar");
  const churchTime = document.getElementById("church-time");
  const churchMapBtns = document.querySelectorAll(".church-map-btn");
  const churchImage = document.getElementById("church-image");

  if (churchNameEn) churchNameEn.textContent = CONFIG.churchName;
  if (churchNameAr) churchNameAr.textContent = CONFIG.churchNameAr;
  if (churchTime) churchTime.textContent = CONFIG.churchTime;
  if (churchImage && CONFIG.churchImage) churchImage.src = CONFIG.churchImage;
  churchMapBtns.forEach((btn) => (btn.href = CONFIG.churchMapLink));
